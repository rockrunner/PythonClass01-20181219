...
# 下载一张图片：读取二进制响应
# resp = requests.get('http://www.woniuxy.com/page/img/banner/online-home.jpg')
# with open("D:\Downloads\myimage", mode='wb') as file:
...
# resp = requests.post(url='http://localhost:8080/customer/add', data=data, cookies=cookie)
# print(resp.text)
...
# data = {'username':'admin', 'password':'admin123', 'verifycode':'0000'}
# session.post('http://localhost:8080/user/login', data=data)
#
# data = {'customername':'接口化测试','customerphone':'138043562346','childsex':'男',
#         'childdate':'2017-12-10','creditkids':'200','creditcloth':'150'}
# resp = session.post(url='http://localhost:8080/customer/add', data=data)
# print(resp.text)
